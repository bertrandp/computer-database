package fr.ebiz.cdb.console.validation;
...
import static fr.ebiz.cdb.binding.ComputerPagerDTO.COLUMN.INTRODUCED;
import static fr.ebiz.cdb.binding.ComputerPagerDTO.COLUMN.NAME;
import static fr.ebiz.cdb.binding.ComputerPagerDTO.ORDER.ASC;
import static fr.ebiz.cdb.binding.ComputerPagerDTO.ORDER.DESC;
import static fr.ebiz.cdb.console.validation.ComputerValidator.DATE_FORMAT_IS_INVALID;
import static fr.ebiz.cdb.console.validation.ComputerValidator.DISCONTINUED_DATE_IS_BEFORE_INTRODUCED_DATE;
import static fr.ebiz.cdb.console.validation.ComputerValidator.NAME_IS_EMPTY;
import static fr.ebiz.cdb.console.validation.ComputerValidator.NAME_IS_TOO_LONG;
